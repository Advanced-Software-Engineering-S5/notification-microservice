...
# from notification_microservice.database import Restaurant, User, Reservation, Notification
# import requests, os
...
#     # TODO: MOVE THIS FUNCTIONS TO RESERVATIONS ST CAN IMPLEMENT CONTACT TRACING
#     # try:
#         # reservations = requests.get(f'{os.environ.GOS_RESERVATION}/customer_reservations/{}')
#     # except:
